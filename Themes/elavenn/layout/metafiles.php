...
<script src="http://localhost:8081/examples/callback.js"></script>
      <script>

if(localStorage.getItem("uuid")){

  console.log(uuid +"   welcome    and coonected");
}


else {
console.log("_finding satrt   with  guest   user_");
  ///window.top.location="";

//<?php// echo Wo_SeoLink('index.php?link1=login');?>
  ///"index.php?link1=login";
}
