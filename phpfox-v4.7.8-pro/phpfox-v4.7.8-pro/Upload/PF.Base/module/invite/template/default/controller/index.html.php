...
<div class="">
	...
	<form class="form" method="post" action="{if $bIsRegistration}{url link='invite.register'}{else}{url link='invite'}{/if}">
		...
		<div class="form-group">
            ...
            <textarea class="form-control autogrow" rows="3" id="emails" name="val[emails]" onkeydown="$Core.resizeTextarea($(this));" onkeyup="$Core.resizeTextarea($(this));" autofocus></textarea>
            <p class="help-block">
