...
class  User_Component_Block_Friendship extends Phpfox_Component
{
    public function process()
    {
        ...
        $this->template()->assign([
            ...
            'requested' => Phpfox::isUser() ? Phpfox::getService('friend.request')->isRequested($user_id, $viewer_id) : false,
            'request_id' => Phpfox::isUser() ? Phpfox::getService('friend.request')->isRequested($viewer_id, $user_id, true) : false
        ]);
