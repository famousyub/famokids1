...
$Core.initSelectize = function () {
  var selectize_items = $('.js_core_init_selectize_form_group select:not(.selectized)');
  if (selectize_items.length) {
    selectize_items.each(function () {
...
$Behavior.disableButtonWhenClick = function () {
  if ($(".js_core_action_button_disable_check").length) {
    $(".js_core_action_button_disable_check").each(function () {
