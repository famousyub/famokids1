                    ...
                    {if Phpfox::getUserParam('profile.can_change_cover_photo')}
                        ...
                        {else}
                            ...
                            <li role="presentation">
                                <a role="button" onclick="$Core.jsConfirm({l}message: oTranslations['are_you_sure_you_want_to_remove_this_cover_photo']{r}, function(){l}$('#cover_section_menu_drop').hide(); $.ajaxCall('user.removeLogo'); return false;{r}, function(){l}{r})">{_p var='remove_cover_photo'}</a>
                            </li>
                        {/if}
                    {/if}
                </ul>
