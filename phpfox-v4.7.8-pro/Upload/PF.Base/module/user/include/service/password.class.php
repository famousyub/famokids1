...
class User_Service_Password extends Phpfox_Service
{
    ...
    public function requestPassword($aVals)
    {
        ...
        Phpfox::getLib('mail')->to($aUser['user_id'])
            ->subject(['user.password_request_for_site_title', ['site_title' => Phpfox::getParam('core.site_title')]])
            ->message(['user.you_have_requested_for_us_to_send_you_a_new_password_for_site_title', [
    ...
    public function verifyRequest($sId)
    {
        ...
        Phpfox::getLib('mail')->to($aRequest['user_id'])
            ->subject(['user.new_password_for_site_title', ['site_title' => Phpfox::getParam('core.site_title')]])
            ->message(['user.you_have_requested_for_us_to_send_you_a_new_password_for_site_title_with_password', [
                    'site_title' => Phpfox::getParam('core.site_title'),
