...
function adv_loadScript(sKey)
{
    var prefix_api = 'https://';

    var script = document.createElement('script');
    script.type= 'text/javascript';
    script.src = prefix_api + 'maps.google.com/maps/api/js?sensor=false&callback=adv_initialize&key=' + sKey;
